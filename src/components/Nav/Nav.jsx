...
const Nav = () => {
	...
	const updateNavState = (payloadToSend) => {
		store.dispatch({ type: 'SET_NAVBAR', payload: payloadToSend })
	}
                    ...
                    ${navbar.currentNav === 'cryptos'}`}
						...
						>
							<div
								...
								data-testid='crypto-link-mobile'
							>
								Cryptos
							</div>
						</Link>
				...
				<div className='nav-desktop-menu'>
					<div className='nav-desktop-menu-item'>
						<Link
							...
							onClick={() => updateNavState('home')}
						>
							<div data-testid='home-link-desktop'>Home</div>
						</Link>
					</div>
					<div className='nav-desktop-menu-item'>
						<Link
							...
							onClick={() => updateNavState('cryptos')}
						>
							<div data-testid='crypto-link-desktop'>Cryptocurrencies</div>
						</Link>
					</div>
				</div>
			</div>
